    ...
    <div class="sidebar px-4 py-4 py-md-4 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    <a href="#" class="m-link" data-bs-toggle="collapse" data-bs-target="#categories">
                        <i class="icofont-chart-flow fs-5"></i> <span>Category Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="categories">
                        <li><a class="ms-link" href="{{route('category.add')}}">Add Category</a></li>
                        <li><a class="ms-link" href="{{route('category.manage')}}">Manage Category</a></li>

                    </ul>
                </li>

                <li class="collapsed">
                    <a href="" class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-sale">
                        <i class="icofont-sale-discount fs-5"></i> <span>Sub Category Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-sale">
                        <li><a class="ms-link" href="{{route('sub-category.add')}}">Add Sub Category</a></li>
                        <li><a class="ms-link" href="{{route('sub-category.manage')}}">Manage Sub Category</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-inventory" href="#">
                        <i class="icofont-chart-histogram fs-5"></i> <span>Brand Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-inventory">
                        <li><a class="ms-link" href="{{route('brand.add')}}">Add Brand</a></li>
                        <li><a class="ms-link" href="{{route('brand.manage')}}">Manage Brand</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Componentsone" href="#"><i
                            class="icofont-ui-calculator"></i> <span>Unit</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-Componentsone">
                        <li><a class="ms-link" href="{{route('unit.add')}}">Add Unit </a></li>
                        <li><a class="ms-link" href="{{route('unit.manage')}}">Manage Unit </a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#app" href="#">
                        <i class="icofont-code-alt fs-5"></i> <span>Product Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="app">
                        <li><a class="ms-link" href="{{route('product.add')}}">Add Product</a></li>
                        <li><a class="ms-link" href="{{route('product.manage')}}"> Manage Product</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-order" href="#">
                        <i class="icofont-notepad fs-5"></i> <span>Order Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-order">
                        <li><a class="ms-link" href="{{route('admin.order-manage')}}">Manage Order</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#customers-info" href="#">
                        <i class="icofont-funky-man fs-5"></i> <span>Customer Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="customers-info">
                        <li><a class="ms-link" href="customers.html">Manage Customers</a></li>
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-product" href="#">
                        <i class="icofont-truck-loaded fs-5"></i> <span>Company Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-product">
                        <li><a class="ms-link" href="product-grid.html">Manage Company</a></li>
                    </ul>
                </li>

                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#customers-info" href="#">
                        <i class="icofont-funky-man fs-5"></i> <span>User Module</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="customers-info">
                        <li><a class="ms-link" href="{{route('user.add')}}">Add User</a></li>
                        <li><a class="ms-link" href="{{route('user.manage')}}">Manage User</a></li>
                    </ul>
                </li>
            </ul>
                                            ...
                                            <ul class="list-unstyled list mb-0">
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{asset('/')}}admin/assets/images/xs/avatar1.svg" alt="">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{asset('/')}}admin/assets/images/xs/avatar3.svg" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{asset('/')}}admin/assets/images/xs/avatar5.svg" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{asset('/')}}admin/assets/images/xs/avatar6.svg" alt="">
                                                        <div class="flex-fill ms-2">
                                                ...
                                                <li class="py-2">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="{{asset('/')}}admin/assets/images/xs/avatar7.svg" alt="">
                                                        <div class="flex-fill ms-2">
                            ...
                            <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                <div class="card border-0 w280">
                                    ...
                                    <div class="list-group m-2 ">
                                        ...
                                        <a href="ui-elements/auth-signin.html" class="list-group-item list-group-item-action border-0 " onclick="event.preventDefault(); document.getElementById('logoutForm').submit();"><i class="icofont-logout fs-5 me-3"></i>Logout</a>
