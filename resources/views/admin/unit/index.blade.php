    ...
    <div class="row">
        <div class="card mb-3">
            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                <h6 class="mb-0 fw-bold ">Add Unit Form</h6>
            </div>
            <div class="card-body">
                ...
                <form action="{{route('unit.create')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-12">
                            <label for="firstname" class="form-label">Unit Name</label>
                            <input type="text" class="form-control" required name="name"/>
                        </div>

                        <div class="col-md-12">
                            <label for="firstname" class="form-label">Unit Code</label>
                    ...
                    <button type="submit" class="btn btn-primary mt-4">Create New Unit</button>
                </form>
            </div>
        </div>
    </div>
