...
Route::middleware(['customer'])->group(function (){
    Route::get('/complete/order', [CustomerOrderController::class, 'index'])->name('customer.order');
...
Route::post('/customer/login', [CustomerAuthController::class, 'signIn'])->name('customer.login');
